...
namespace MultiSpeak4
{
    ...
    /// Summary description for Web Services Hosted by Work Task Performer(WTP). 
    /// </summary> 
    ///  
    ...
    public class WTP_Server : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "Requester pings URL of WTP to see if it is alive. Returns errorObject(s) as necessary to communicate application status.")]
        ...
        [WebMethod(Description = "Requester requests list of methods supported by WTP.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
        ...
        #region Methods for Getting Data from the WTP system
        ...
        #region Methods for Modification of WTP data by external system
        ...
        #region Methods for  Publisher to publish Event Notification to WTP (The subscriber)
        
        [WebMethod(Description = "Publisher notifies WTP of new or changed assignment(s) by sending the changed assignment object(s).  WTP returns information about failed transactions using an array of errorObjects.  The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
        ...
        [WebMethod(Description = "Publisher notifies WTP of new or changed group assignment(s) by sending the changed groupAssignment object(s).  WTP returns information about failed transactions using an array of errorObjects. The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
        ...
        [WebMethod(Description = "Publisher notifies WTP of revocation of assignment(s) by sending the unassignment object(s).  WTP returns information about failed transactions using an array of errorObjects. The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
