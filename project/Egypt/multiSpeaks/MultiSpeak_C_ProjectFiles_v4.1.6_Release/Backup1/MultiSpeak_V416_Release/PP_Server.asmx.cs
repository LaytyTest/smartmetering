...
namespace MultiSpeak4
{
    ...
    /// Summary description for Web Services Hosted by Payment Processing(PP). 
    /// </summary> 
    ///  
    [WebService(Namespace = "http://www.multispeak.org/Version_4.1_Release")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    public class PP_Server : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "Requester pings URL of PP to see if it is alive. Returns errorObject(s) as necessary to communicate application status.")]
        ...
        [WebMethod(Description = "Requests list of methods supported by PP.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
