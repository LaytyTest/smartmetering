...
namespace MultiSpeak4
{
    ...
    /// Summary description for Web Services Hosted by Inspection(INSP). 
    /// </summary> 
    ///  
    ...
    public class INSP_Server : System.Web.Services.WebService
    {
        ...
        #region Methods for Getting Data from the INSP system
        ...
        #region Methods for Modification of INSP data by external system
        ...
        #region Methods for  Publisher to publish Event Notification to INSP(The subscriber)
