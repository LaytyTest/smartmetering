...
namespace MultiSpeak4
{
    ...
    /// Summary description for Web Services Hosted by Work Viewer(WV). 
    /// </summary> 
    ///  
    ...
    public class WV_Server : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "Requester pings URL of WV to see if it is alive. Returns errorObject(s) as necessary to communicate application status.")]
        ...
        [WebMethod(Description = "Requester requests list of methods supported by WV.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
        ...
        #region Methods for Getting Data from the WV system
        ...
        #region Methods for Modification of WV data by external system
        ...
        #region Methods for  Publisher to publish Event Notification to WV(The subscriber)
