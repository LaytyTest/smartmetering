...
namespace MultiSpeak4
{
    ...
    /// Summary description for Web Services Hosted by Work Task Generator(WTG). 
    /// </summary> 
    ///  
    ...
    public class WTG_Server : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "Requester pings URL of WTG to see if it is alive. Returns errorObject(s) as necessary to communicate application status.")]
        ...
        [WebMethod(Description = "Requester requests list of methods supported by WTG.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
        ...
        #region Methods for Getting Data from the WTG system
        ...
        #region Methods for Modification of WTG data by external system
        ...
        #region Methods for  Publisher to publish Event Notification to WTG (The subscriber)
        ...
        [WebMethod(Description = "Publisher notifies WTG that a work or service order number has been generated in response to a previous InitiateWorkRequest on the part of the WTO. WTG returns failed transactions in an array of errorObjects. The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
