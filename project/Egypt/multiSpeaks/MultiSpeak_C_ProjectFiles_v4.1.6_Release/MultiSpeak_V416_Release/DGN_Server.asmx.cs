...
namespace MultiSpeak4
{
	...
	/// Web Services Hosted by the Design function. 
	/// </summary> 
	///  
	...
	public class DGN_Server : System.Web.Services.WebService 
	{
		...
		#region Generic for each interface
			...
			[WebMethod(Description="Requester pings URL of Design to see if it is alive.  Returns errorObject(s) as necessary to communicate application status.")]
			...
			[WebMethod(Description="Requests list of methods supported by Design.")]
			[SoapHeader("MultiSpeakMsgHeader", Direction=SoapHeaderDirection.InOut)]
		...
		#region Methods for Getting Data from the Design system

			[WebMethod(Description="Returns all required data for a specific designed workOrder.")]
			[SoapHeader("MultiSpeakMsgHeader", Direction=SoapHeaderDirection.InOut)]
			public workOrder GetFAWorkOrder(string woNumber, string jobNumber)
			{
				return null;
			}

            [WebMethod(Description = "Returns a specific project that has been modified by DGN. The project is referred to by using an objectRef; the name is the human-readable objectName for the project instance, the noun (if used) is 'project', the objectID is the objectID for this project instance.  If the system of record can resolve the name then the noun and objectID are not required, but the default condition is that the noun and objectID are required in order to uniquely resolve the project. ")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            public project GetFAProject(objectRef projectID)
            {
                return null;
            }
            
            [WebMethod(Description = "Returns all required data for a designed workOrder as specified by the work order objectID. ")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            public workOrder GetFAWorkOrderByObjectID(string woObjectID)
            {
                return null;
            }
            ...
            [WebMethod(Description = "Returns a list of work orders in the design system.The calling parameter lastReceived is included so that large sets of data can be returned in manageable blocks.  lastReceived should carry an empty string the first time in a session that this method is invoked.  When multiple calls to this method are required to obtain all of the data, the lastReceived should carry in subsequent calls the objectID of the data instance noted by the server as being the lastSent.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Returns a list of work orders in the design system, selected by work order status. The calling parameter lastReceived is included so that large sets of data can be returned in manageable blocks.  lastReceived should carry an empty string the first time in a session that this method is invoked.  When multiple calls to this method are required to obtain all of the data, the lastReceived should carry in subsequent calls the objectID of the data instance noted by the server as being the lastSent.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Returns a specific work order by work order identifier (woNumber and jobNumber).")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            public workOrder GetGISWorkOrder(string woNumber, string jobNumber)
            {
                return null;
            }
            [WebMethod(Description = "Returns a specific work order by work order objectID. ")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            public workOrder GetGISWorkOrderByObjectID(string woObjectID)
            {
                return null;
            }

            [WebMethod(Description = "The client requests the DGN to reserve a work or service order number. The DGN returns a reserved work or service order in the form of a requestedNumber.  ")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Returns the aggregated task requirements for a specific workTask.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            public taskAggregation GetTaskAggregation(string workTaskID)
            {
                return null;
            }
		...
		#region Methods to Modify Data on the Staking system

			[WebMethod(Description="Permits client to request modification of the status of a specific workOrder on Design.  If this transaction should fail, Design returns information about the failure to the client using the SOAPFault.")]
			[SoapHeader("MultiSpeakMsgHeader", Direction=SoapHeaderDirection.InOut)]
            public errorObject[] ModifyWorkOrderStatus(string woNumber, string jobNumber, string statusCode) 
			{
                return null;
			}

            [WebMethod(Description = "Permits client to request modification of the status of a specific workOrder on Design.  If this transaction should fail, Staking returns information about the failure to the client using the SOAPFault.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            public errorObject[] ModifyWorkOrderStatusByObjectID(string objectID, string statusCode)
            {
                return null;
            }
		...
		#region Methods to publish Event Notification to Design(The subscriber)
            ...
            [WebMethod(Description = "Publisher notifies Design of a change in material management assemblies by sending the changed materialManagementAssembly object.  Design returns information about failed transactions using an aray of errorObjects. The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data.")]
			[SoapHeader("MultiSpeakMsgHeader", Direction=SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Publisher notifies Design of a change in material items by sending the changed materialItem object.  Design returns information about failed transactions using an aray of errorObjects. The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data.")]
			[SoapHeader("MultiSpeakMsgHeader", Direction=SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Publisher notifies Design of a change in work orders by sending the changed elements of the work order. FA returns failed transactions using an array of errorObjects.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            public errorObject[] UpdateWO(extensionsItem[] woUpdates)
            {
                return null;
            }
            [WebMethod(Description = "Publisher notifies subscriber of new or changed project(s). Subscriber returns information about failed transactions using an array of errorObjects. The transactionID calling parameter links this Update request with the published data method call ProjectChangedNotification.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            public errorObject[] UpdateProjects(project[] projects, string transactionID)
            {
                return null;
            }
            [WebMethod(Description = "Publisher notifies DGN that a previously reserved work or service order number is being returned. DGN returns failed transactions using an errorObject.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Publisher notifies Design of new or changed assignment(s) by sending the changed assignment object(s).  Design returns information about failed transactions using an array of errorObjects. The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Publisher notifies DGN that a work or service order number has been generated in response to a previous  InitiateWorkRequest on the part of the DGN. DGN returns failed transactions using an errorObject.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Publisher notifies DGN of new or changed project(s). DGN returns information about failed transactions using an array of errorObjects. The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data. The transactionID calling parameter links this Notification request with the UpdateProject method call that requested the change.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
            ...
            [WebMethod(Description = "Publisher notifies Design of a change in labor categories by sending the changed laborCategory objects.  Design returns information about failed transactions using an aray of errorObjects. The message header attribute 'registrationID' should be added to all publish messages to indicate to the subscriber under which registrationID they received this notification data.")]
            [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
