...
namespace MultiSpeak4
{
    ...
    /// Summary description for Web Services Hosted by Work Task Originator(WTO). 
    /// </summary> 
    ///  
    ...
    public class WTO_Server : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "Requester pings URL of WTO to see if it is alive. Returns errorObject(s) as necessary to communicate application status.")]
        ...
        [WebMethod(Description = "Requester requests list of methods supported by WTO.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
        ...
        #region Methods for Getting Data from the WTO system
        ...
        #region Methods for Modification of WTO data by external system
        ...
        #region Methods for  Publisher to publish Event Notification to WTO (The subscriber)
        
        [WebMethod(Description = "Publisher notifies WTO that a work or service order number has been generated in response to a previous  InitiateWorkRequest on the part of the WTO. WTO returns failed transactions in an array of errorObjects.")]
        [SoapHeader("MultiSpeakMsgHeader", Direction = SoapHeaderDirection.InOut)]
